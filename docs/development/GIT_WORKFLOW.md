...
الافتراضي هو الاحتفاظ بفروع العمل بعد الدمج لأغراض التتبع. لا يحذف أي فرع محلي أو بعيد تلقائيًا؛ لا يكون الحذف مسموحًا إلا بعد التحقق من وصول نتيجته إلى `develop` وصدور طلب صريح من مالك المشروع.
