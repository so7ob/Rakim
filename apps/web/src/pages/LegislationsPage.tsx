    ...
    <>
      <section className="public-page-hero">
        <div className="container">
          ...
          <span className="eyebrow">قاعدة تشريعية موحدة</span>
          <h1>{archived ? "أرشيف التشريعات" : "التشريعات"}</h1>
          <p>
            {archived
              ? "النصوص الملغاة والمؤرشفة محفوظة للبحث والرجوع التاريخي."
              : "فلترة واستعراض القوانين والقرارات واللوائح والاتفاقيات المنشورة."}
          </p>
        </div>
      </section>
